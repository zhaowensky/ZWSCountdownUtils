...
###################工程信息以及最下面的蒲公英信息########################
#工程名
PROJECTNAME="ZWSCountdown"
#需要编译的 targetName
TARGET_NAME="ZWSCountdown"
# ADHOC
#证书名#描述文件
ADHOCCODE_SIGN_IDENTITY="iPhone Distribution: Guangzhou Yunkang Information Technology Co., Ltd."
ADHOCPROVISIONING_PROFILE_NAME="828db35e-dd8b-4c57-b3be-5b843bb99c1e"
